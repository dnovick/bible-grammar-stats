...
|---|---|---|
| **Thematic (ω-verbs)** | Connecting vowel (ο/ε) between stem and ending | λύ**ω**, λύ**ε**ις, λύ**ε**ι |
| **Athematic (μι-verbs)** | No connecting vowel; endings attach directly to stem | δίδω**μι**, δίδω**ς**, δίδω**σι** |
