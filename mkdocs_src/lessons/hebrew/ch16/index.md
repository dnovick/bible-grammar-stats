...
| File | Description |
|---|---|
| [qal-imperfect-paradigm.md](../ch15/qal-imperfect-paradigm.md) | Strong paradigm reference (from Ch15) |
| [qal-imperfect-weak-lamed-aleph-paradigms.md](qal-imperfect-weak-lamed-aleph-paradigms.md) | III-א weak Imperfect paradigms |
| [qal-imperfect-weak-lamed-he-paradigms.md](qal-imperfect-weak-lamed-he-paradigms.md) | III-ה weak Imperfect paradigms + Jussive/Wayyiqtol |
| [qal-imperfect-weak-lamed-guttural-paradigms.md](qal-imperfect-weak-lamed-guttural-paradigms.md) | III-ח/ע weak Imperfect paradigms |
| [qal-imperfect-weak-pe-guttural-paradigms.md](qal-imperfect-weak-pe-guttural-paradigms.md) | I-guttural weak Imperfect paradigms |
| [qal-imperfect-weak-pe-paradigms.md](qal-imperfect-weak-pe-paradigms.md) | I-נ and I-י weak Imperfect paradigms (combined) |
| [qal-imperfect-weak-biconsonantal-paradigms.md](qal-imperfect-weak-biconsonantal-paradigms.md) | Biconsonantal Imperfect paradigms + Wayyiqtol |
| [qal-imperfect-weak-geminate-paradigms.md](qal-imperfect-weak-geminate-paradigms.md) | Geminate Imperfect paradigms with Biconsonantal comparison |
...
|---|---|---|
| [ch16-morphology-deck.md](ch16-morphology-deck.md) | Markdown | 40-card morphology deck — Qal Imperfect Weak forms across all eight weak root classes |
| [ch16-morphology-deck.txt](ch16-morphology-deck.txt) | Anki import | Morphology deck — tab-separated, ready for Anki File → Import (40 cards) |
| [ch16-morphology-deck-fd.txt](ch16-morphology-deck-fd.txt) | Flashcards Deluxe | Morphology deck — tab-separated, ready for Flashcards Deluxe import (40 cards) |
| [ch16-vocab-deck.md](ch16-vocab-deck.md) | Markdown | Vocabulary deck — 15 words (10 verbs, 3 nouns, 2 other) with POS tags and frequency |
...
→ Full paradigm: [qal-imperfect-weak-lamed-aleph-paradigms.md](qal-imperfect-weak-lamed-aleph-paradigms.md)
...
→ Full paradigm: [qal-imperfect-weak-lamed-he-paradigms.md](qal-imperfect-weak-lamed-he-paradigms.md)

### Corpus Examples

- **Gen 2:19** — וַיִּצֶר֩ יְהוָ֨ה — wayyiqtol of יצר (I-gutt.; for comparison)
- **Gen 1:7** — **וַיַּ֣עַשׂ** אֱלֹהִ֔ים אֶת־הָרָקִ֑יעַ — "and God made" (wayyiqtol of עשה III-ה)
- **Gen 2:22** — **וַיִּ֣בֶן** יְהוָ֘ה אֱלֹהִים֮ — "and the LORD God built" (wayyiqtol of בנה III-ה)
- **Gen 3:1** — **תַּעֲשֶׂ֑ה** כִּ֤י — "that you do/make" (2ms/3fs long form; III-ה seghol-he ending)
...
→ Full paradigm: [qal-imperfect-weak-lamed-guttural-paradigms.md](qal-imperfect-weak-lamed-guttural-paradigms.md)
...
- **I-guttural:** composite shewa (chateph-patach) under the guttural; the prefix vowel
  before it often shifts:
...
→ Full paradigm: [qal-imperfect-weak-pe-guttural-paradigms.md](qal-imperfect-weak-pe-guttural-paradigms.md)
...
→ Full paradigm: [qal-imperfect-weak-pe-paradigms.md](qal-imperfect-weak-pe-paradigms.md) (Part 1)
...
- **Gen 4:12** — **תִּתֵּן** לְךָ הָאָרֶץ אֶת יְבוּלָהּ — "the ground shall not yield its strength to you" (3fs Imperfect of נתן)
...
→ Full paradigm: [qal-imperfect-weak-pe-paradigms.md](qal-imperfect-weak-pe-paradigms.md) (Part 2)
...
- **The "long" Imperfect form has no R2 consonant** — the middle vowel fills that position:
  יָקוּם (from קוּם), יָבוֹא (from בּוֹא), יָשׁוּב (from שׁוּב)
...
→ Full paradigm: [qal-imperfect-weak-biconsonantal-paradigms.md](qal-imperfect-weak-biconsonantal-paradigms.md)
...
- **Biconsonantal confusable:** both classes can show qamets under prefix + short root;
  root knowledge is required
...
→ Full paradigm: [qal-imperfect-weak-geminate-paradigms.md](qal-imperfect-weak-geminate-paradigms.md)
