...
- Perfect: קַטֵּל — note dagesh forte in ט (R2)
- Imperfect: יְקַטֵּל — note dagesh forte in ט (R2)
- Imperative: קַטֵּל — note dagesh forte in ט (R2)
- Infinitive: קַטָּלָה — note dagesh forte in ט (R2)
- Participle: מְקַטֵּל — note dagesh forte in ט (R2)
...
The most common Pael verb in Daniel is **שַׁבַּח** (to praise), built on root שׁבח. This verb is the Pael perfect 3ms: שַׁבַּח = "he praised." The dagesh forte is in ב (R2): שַׁ**בּ**ַח.
...
- **Peal imperfect 3ms:** יִכְתֻּב ("he will write") — prefix = יִ- (hireq)
- **Pael imperfect 3ms:** יְקַטֵּל ("he will/does [intensively/declaratively]") — prefix = יְ- (shewa)
...
- **Lamed prefix** (לְ-)
- **R1** with patach
- **R2** with dagesh forte + qamets (long ā)
- **Feminine suffix** -ָה
...
- **מְשַׁבַּח** — Pael active participle ms of שׁבח; with the copula אֲנָא = "I am praising / I praise"
- Note the Pael marker: dagesh forte in ב (R2)
...
- **שַׁבְּחֵת** — Pael perfect 1cs of שׁבח ("I praised")
- Note: tsere under R2 retained; tāw suffix = 1cs marker
...
- **נְחַוֵּא** — Pael imperfect 1cp of חוה ("we will declare/show")
- The יְ-/נְ- prefix + III-he ending -ֵא = clear Pael imperfect marker
...
- **בָּרֵךְ** — Pael perfect 3ms of ברך
- Pattern: בָ (qamets on R1) + רֵ (tsere on R2) + ךְ (R3) — note R1 has qamets not patach here; variant of the standard patach (qamets in pause or before resh)
...
- **בָּרִיךְ** — This is actually a **Peal passive participle** (qəṭīl pattern, not Pael), used as a stative predicate: "Blessed be…"
- Compare the Pael **מְבָרֵךְ** = "one who blesses" (active participle) — note the מְ- prefix distinguishes Pael participle from Peal passive participle
...
- **יְשַׁבַּח** — Pael imperfect 3ms of שׁבח
- Prefix יְ- (not יִ-) — D-stem marker
...
- **שְׁלַח** here is Peal; the Pael form would be **שַׁלַּח** (intensive/causative: "dispatched"), with dagesh forte in ל (R2)
...
- **קַבֵּל** — Pael perfect 3ms of קבל
- Patach under ק (R1), tsere under ב (R2) with dagesh forte, ל (R3)
