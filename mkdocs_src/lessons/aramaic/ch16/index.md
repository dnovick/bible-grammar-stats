...
- The **subject** of a clause: "To write is difficult."
- The **object** of a finite verb: "He commanded [him] to write."
- The **complement** of verbs of beginning, finishing, continuing, being able, or wanting: "He began to write."
- A **temporal clause** with כְּ: "When he wrote…" / "When the writing happened…"
- A **purpose clause** with לְ: "in order to write" / "for the purpose of writing"
...
- **מִ-** prefix: a characteristic mem with hireq
- **קְ-**: the first root consonant with a vocal shewa
- **טַ**: the second root consonant with patach (a-class vowel)
- **ל**: the third root consonant
...
- Root **נתן** (to give): infinitive **מִנְתַּן** (the nun is retained before the second radical)
- Root **נפל** (to fall): infinitive **מִנְפַּל** (nun retained)
