...
> → λόγος is the subject (with article ὁ); θεός is the predicate nominative (no article)
...
> → τόν κόσμον is accusative: it receives the action of "loves"

> ἐγείρω τὸν νεκρόν — "I raise **the dead (man)**"
