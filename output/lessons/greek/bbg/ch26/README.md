...
|---|---|---|
| Masculine/Neuter participle stems | **Third declension** (stem in -ντ-) | λύ**ων**, λύ**οντος** |
| Feminine participle stems | **First declension** | λύ**ουσα**, λύ**ουσης** |
| Middle/Passive participle stems | **2-1-2 declension** (like regular adjectives) | λυό**μενος**, λυο**μένη**, λυό**μενον** |
