...
1. Trace the letter shape — attend to direction of strokes
2. Write the lowercase form 5× without looking
3. Write the uppercase form 5× without looking
4. Write the letter's name aloud
5. Say the sound aloud as you write
