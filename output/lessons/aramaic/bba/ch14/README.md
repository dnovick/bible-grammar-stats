...
- **Future action** — what *will* happen: "he will write"
- **Modal action** — what *may* or *should* happen: "he may write," "let him write"
- **Progressive or habitual action** — what *was happening* or *used to happen* in the past (especially in subordinate clauses)
...
### 2.1 The Abstract Pattern — יִקְטֻל
...
- **Prefix יִ-** — the third-masculine-singular prefix; the yod + hireq is characteristic of the Aramaic imperfect
- **Root consonants ק-ט-ל** — the three radicals
- **Stem vowel ֻ (shureq/qibbuts)** — the characteristic **u-class vowel** under the third radical; this is the diagnostic of the standard Peal imperfect pattern
...
### 2.2 The Actual Paradigm — יִכְתֻּב (Peal imperfect of כְּתַב "to write")
...
## 3. Comparison to the Hebrew Qal Imperfect
...
## 4. The Vowel Pattern — u-Class and i-Class Verbs
...
## 5. Weak Verb Patterns in the Peal Imperfect
...
### 5.1 I-Aleph Verbs — אֲמַר (to say) → יֵאמַר / יֵימַר
...
- 3ms Peal perfect: אֲמַר
- 3ms Peal imperfect: **יֵאמַר** (or **יֵימַר** in some manuscripts)
...
### 5.2 I-Nun Verbs — נְפַל (to fall) → יִפַּל
...
- 3ms Peal perfect: נְפַל (nun is fully written — no assimilation in perfect)
- 3ms Peal imperfect: **יִפַּל** (nun assimilates → dagesh in peh)
...
### 5.3 I-Waw / I-Yod Verbs — יְהַב (to give) → יִנְתֵּן
...
### 5.4 Hollow Verbs — קוּם (to arise) → יְקוּם
...
- 3ms Peal perfect: קָם (qamets-aleph contraction)
- 3ms Peal imperfect: **יְקוּם** (shewa prefix + long ū between first and third radical)
...
### 5.5 III-Aleph Verbs — שׁנא (to change) → יִשְׁנֵא
...
- 3ms Peal imperfect: **יִשְׁנֵא** (tsere + aleph mater)
...
### 5.6 III-He Verbs — הֲוָה (to be) → יֶהֱוֵא; בְּנָה (to build) → יִבְנֵא
...
#### הֲוָה (to be, to exist, to happen)
...
### 5.7 Geminate Verbs — עלל (to enter) → יְעֻל / יֵעֻל
...
## 6. Translation — Imperfect Aspect in Biblical Aramaic
...
### 6.2 Modal Uses — "May," "Should," "Must"
...
### 6.3 Progressive / Habitual Past (in Subordinate Clauses)
...
### 6.4 Jussive — Third-Person Wish or Command
...
## 7. The Peal Imperfect in Daniel and Ezra — Illustrative Examples
...
## 8. The Jussive — Third-Person Imperfect as Wish or Command
...
## 9. Summary Paradigm Table

### Strong Verb — יִכְתֻּב (Peal imperfect of כְּתַב "to write")
...
### Diagnostic Prefixes — Quick Reference
...
### Diagnostic Suffixes — Quick Reference
...
1. **Same prefix system as Hebrew Qal imperfect** — יִ-, תִּ-, אֶ-, נִ- are identical to Hebrew. The imperfect "looks like" Hebrew from the prefix perspective.

2. **The stem vowel is u, not o** — Aramaic Peal imperfect uses qibbuts/shureq (יִקְטֻל), not the Hebrew holem (יִקְטֹל). This is the first thing to check when distinguishing Hebrew from Aramaic imperfects.

3. **The plural and 2fs forms add a final nun** — יִכְתְּבוּן (not יִכְתְּבוּ), תִּכְתְּבִין (not תִּכְתְּבִי). This "energic nun" is diagnostic for Aramaic.

4. **I-nun assimilation happens in the imperfect (unlike the perfect)** — נפל → יִפַּל; the nun disappears into a dagesh forte in peh. Exactly as in Hebrew Qal imperfect (Hebrew יִפֹּל, Aramaic יִפַּל — same pattern).

5. **I-aleph roots lengthen the prefix vowel** — יִ- → יֵ- before a quiescent aleph (יֵאמַר). The tsere prefix is a reliable I-aleph imperfect marker.

6. **Hollow verb imperfects have shewa prefix** — יְקוּם, not יִקוּם. The shewa under the prefix (יְ-) in a hollow-looking stem is a signal.

7. **יהב has a suppletive imperfect: יִנְתֵּן** — the most important lexical irregularity in BBA. "To give" switches roots between perfect and imperfect.

8. **יֶהֱוֵא is the most frequent imperfect in the corpus** — master it cold. It appears in formulas, decrees, visions, and doxologies.

9. **The jussive = the 3rd person imperfect** — there is no separate jussive form. Context determines whether "he will write" or "let him write" is the correct rendering.

10. **3ms and 2ms are identical** — תִּכְתֻּב can be either. Subject pronouns or context disambiguate.
