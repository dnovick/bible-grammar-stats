...
- The **Peil** (Gp stem) — the **simple passive** of the Peal
- The **Hithpeel / Ithpeel** (Gt stem) — the **reflexive/passive** of the Peal
...
## 2. The Peil — Simple Passive of the Peal

### 2.1 What the Peil Means
...
### 2.2 The Peil Perfect — Pattern: קְטִיל

The diagnostic feature of the Peil is the **qəṭīl vowel pattern** on the perfect:

- **R1** takes a **vocal shewa** (ְ)
- **R2** takes **hireq** (ִ) followed by **yod** (mater lectionis) — producing the long ī vowel
- The pattern reads: קְ-טִי-ל = *qəṭīl*
...
### 2.3 The Peil Imperfect — Pattern: יִקְטֵל
...
- The **imperfect prefix** (יִ- / תִ- / נִ- / אֶ-) is the same as the Peal imperfect
- **R1** takes a **vocal shewa**
- **R2** takes **tsere** (ē-class vowel)
- The stem pattern reads: קְ-טֵ-ל
...
1. Is it functioning as a finite verb (making a predicate claim)? → Peil perfect (passive past)
2. Is it functioning as an adjective (describing the state of a noun)? → Peal passive participle
...
## 3. The Peil in the Biblical Text

### 3.1 Selected Peil Perfect Forms from Daniel and Ezra
...
### 3.2 Selected Peil Imperfect Forms
...
## 4. The Hithpeel and Ithpeel — Reflexive/Passive of the Peal

### 4.1 One Stem, Two Names
...
- **Hithpeel** — prefixed with **הִתְ-** (hē + tāw): הִתְקְטִל
- **Ithpeel** — prefixed with **אִתְ-** (aleph + tāw): אִתְקְטִל
...
### 4.2 What the Hithpeel/Ithpeel Means

The Gt stem expresses:

1. **Reflexive action** — the subject acts on itself: "He killed himself" / "They gathered themselves"
2. **Passive action** — the subject is acted upon: "He was gathered" / "It was filled"
3. **Reciprocal action** — subjects act on each other (rarer): "They consulted with one another"
...
## 5. The Hithpeel/Ithpeel in Full — Forms and Paradigms

### 5.1 The Perfect — Pattern: הִתְקְטִל / אִתְקְטִל
...
### 5.2 The Imperfect — Pattern: יִתְקְטֵל / יֶתְקְטֵל
...
- The prefix syllable takes the form **יִתְ-** (or יֶתְ- in some forms)
- R1 then takes a **vocal shewa**
- R2 takes **tsere** (ē)
...
### 5.3 The Infinitive — Pattern: הִתְקְטָלָה / לְהִתְקְטָלָה
...
### 5.4 The Participle — Pattern: מִתְקְטֵל

The Hithpeel/Ithpeel participle uses the prefix **מִתְ-**:

- **מ-** is the characteristic participle prefix (same as in Hebrew — the Niphal participle uses נִ- while derived stems use מ-)
- **תְ** is the Gt stem marker
- R1 takes a **vocal shewa**
- R2 takes **tsere** (ē)
...
## 6. Metathesis in the Ithpeel/Hithpeel

### 6.1 What is Metathesis?
...
## 7. Summary: Peal → Peil → Ithpeel Comparison Table
...
### How to Distinguish the Three Forms
...
## 8. Hithpeel and Ithpeel Examples from Daniel and Ezra
...
## 9. Key Diagnostic Summary

### How to Identify a Peil Form

1. **Perfect:** Does the form show a **hireq-yod** (ִי) between R2 and R3, with a vocal shewa under R1? → Peil perfect (or Peal passive participle — check context)
2. **Imperfect:** Does the form show the standard imperfect prefix with a **tsere** (ֵ) under R2? → Peil imperfect (compare Peal imperfect which has qibbuts/u-vowel under R2)
3. There is no distinct Peil participle — use the Peal passive participle (qəṭīl pattern) for participial function

### How to Identify a Hithpeel/Ithpeel Form

1. **Perfect:** Does the form begin with **הִתְ-** or **אִתְ-**? → Hithpeel/Ithpeel perfect
2. **Imperfect:** Does the form show **יִתְ-** (tāw after the prefix vowel, before R1)? → Ithpeel imperfect
3. **Participle:** Does the form begin with **מִתְ-**? → Ithpeel participle
4. **Metathesis:** Does the form show הִשְׁתַּ- / אִשְׁתַּ- / יִשְׁתַּ-? → Ithpeel with sibilant R1 (root begins with שׁ, שׂ, ס, etc.)

---

## 10. Key Points for Hebrew Students — Summary

1. **The Peil is the Aramaic simple passive where Hebrew uses the Qal passive (rare) or Hophal.** The qəṭīl pattern (hireq-yod on R2) is Aramaic's standard passive perfect. Whenever you see this pattern functioning as a finite verbal predicate, identify it as Peil perfect.

2. **The Peil 3ms perfect looks exactly like the Peal passive participle.** Both are קְטִיל in form. Parse them by function: finite predicate = Peil perfect; adjectival/nominal = Peal passive participle.

3. **The Ithpeel is the Aramaic Niphal.** Just as Hebrew uses the Niphal (נִקְטַל) as the passive/reflexive of the Qal, Aramaic uses the Ithpeel (אִתְקְטִל / הִתְקְטִל). The prefix consonant differs (Hebrew nûn vs. Aramaic tāw), but the function is identical.

4. **The Hithpeel (הִתְ-) and Ithpeel (אִתְ-) are the same stem.** Both forms appear in the biblical text; context does not require distinguishing them. Some texts use the he-prefixed form, others the aleph-prefixed form.

5. **The Ithpeel imperfect adds tāw after the prefix vowel: יִתְקְטֵל.** This distinguishes it from the Peal (יִקְטֻל) and Peil (יִקְטֵל) imperfects. The three-way contrast יִקְטֻל / יִקְטֵל / יִתְקְטֵל is one of the core diagnostics for these stems.

6. **Metathesis with sibilant R1 is the same rule as Hebrew Hitpael metathesis.** When a root begins with שׁ, שׂ, ס, or צ, the tāw and the sibilant switch positions. הִשְׁתְּכַח (was found) = root שׁכח + Hithpeel + metathesis. Always check: "Could the initial שׁ or ס be R1, with a metathesized tāw after it?"

7. **The Ithpeel participle uses the מִתְ- prefix.** The ms form is מִתְקְטֵל; mp is מִתְקְטְלִין. The מ- prefix signals participle (as in Hebrew and as in other Aramaic derived stem participles), and the תְ- signals the Gt stem.

8. **Chapters 18–22 have no vocabulary list** — the derived stems use roots you already know from the Peal. Your job is to recognize the stem and read the familiar root in its new functional guise.
