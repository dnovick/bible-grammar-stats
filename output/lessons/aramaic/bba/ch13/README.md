...
- **Stative verbs** describing a present state resulting from a past event: זְכַר "he remembers" (the state of having-called-to-mind)
- **Perfective present** in narrative discourse: a completed act reported as historical fact
- **Instantaneous present** in formulas and proclamations
...
## 2. The Strong Verb Paradigm — Full Peal Perfect of כְּתַב
...
## 3. Comparison with the Hebrew Qal Perfect
...
### Key Diagnostic Differences — What to Watch For
...
## 4. Vowel Pattern of the Strong Peal Perfect

The strong Peal perfect of כְּתַב displays a characteristic vowel pattern that repeats across most strong roots:

- **Base stem vowels:** shewa under first radical + patach under second radical → כְּ-תַ-ב
- This is the **a-class pattern** (patach on the second radical in the 3ms)
- When endings are added that begin with a consonant (like **ְתְּ-** or **ְנָא-**), the patach on the second radical often remains, but the vowel under the first radical may shift
...
> **Pattern to memorize:** The qamets in the pre-tonic syllable of the 1cs (כְּ**תָ**בֵת) is the most reliable internal vowel signal that you are looking at a 1cs form.

---

## 5. Weak Verb Patterns in the Peal Perfect
...
### 5.1 I-Aleph Verbs (e.g., אֲמַר — to say)
...
### 5.2 I-Nun Verbs (e.g., נְפַל — to fall)
...
> **Important distinction:** The I-nun assimilation (nun → dagesh in next letter) that you know from Hebrew Qal imperfect (יִפֹּל from יִנְפֹּל) does **not** occur in the Aramaic Peal perfect. The perfect is the "safe zone" for I-nun roots. Assimilation does occur in the Aramaic imperfect and imperative, but not here.

### 5.3 Hollow Verbs (e.g., קָם from קוּם — to arise)
...
### 5.4 III-Aleph Verbs (e.g., שְׁנֵא — to change, to be different)
...
### 5.5 III-He Verbs (e.g., הֲוָה — to be; בְּנָה — to build)
...
#### הֲוָה (to be, to happen, to exist)
...
### 5.6 Geminate Verbs (e.g., עַל — to enter)
...
## 6. Translation — Perfect Aspect in Biblical Aramaic

### The Default Translation: Simple Past
...
## 7. The Peal Perfect in Daniel and Ezra — Illustrative Examples
...
## 8. The Copula הֲוָה — "To Be" in the Perfect
...
### הֲוָה + Participle = Past Progressive
...
### Diagnostic Endings — Quick Reference
...
1. **The 3ms Peal perfect is always the lexical (dictionary) form** — same convention as Hebrew 3ms Qal perfect.

2. **Three endings to fix in memory** as uniquely Aramaic (not Hebrew cognates):
   - 1cs: **-ֵת** (tsere + tav) — Hebrew has **-תִּי**
   - 1cp: **-נָא** — Hebrew has **-נוּ**
   - 2mp: **-תּוּן** — Hebrew has **-תֶּם**

3. **The 3fs ending is -ַת (patach + tav)** — not the Hebrew -âh. The form that ends in tav is feminine singular in Aramaic.

4. **No wayyiqtol:** Where Hebrew narrative uses וַיִּכְתֹּב, Aramaic narrative uses כְּתַב. The narrative perfect in Aramaic is the workhorse of the storyline.

5. **I-aleph roots take hateph-patach** under the aleph in the 3ms — not plain shewa (because aleph cannot take a silent shewa).

6. **Hollow verbs contract** the middle waw to a long qamets in the base: קָם, not *קוּמ.

7. **III-he verbs drop the final he** before the tav endings (3fs, 2ms) — הֲוָה → הֲוָת.

8. **הֲוָה + participle** is a past progressive periphrastic construction — unique to Aramaic narrative; learn to recognize it on sight.
