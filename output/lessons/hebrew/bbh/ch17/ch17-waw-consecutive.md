# Chapter 17 — Waw-Consecutive (Wayyiqtol and Weqatal)
...
- **וַ + dagesh forte** in the prefix consonant (יִ → יִּ, תִּ → תִּ already has dagesh, etc.)
- The form is otherwise **identical to the Jussive** (short imperfect) where a Jussive form exists
- For **strong verbs:** indistinguishable from Imperfect in form, except for the וַ prefix
- For **weak verbs** (III-ה, Biconsonantal, Geminate): the Wayyiqtol uses the **short (jussive) form**
  - III-ה: יִבְנֶה (Imperfect) → וַיִּבֶן (Wayyiqtol — ה drops)
  - Biconsonantal: יָקוּם (Imperfect) → וַיָּ֫קׇם (Wayyiqtol — short form with qamets hatuf)
  - Geminate: יִסֹּב (Imperfect) → וַיָּ֫סׇּב (Wayyiqtol)
- **1cs exception:** אֶקְטְלָה (cohortative) → Wayyiqtol 1cs = וָאֶקְטֹל (no dagesh in aleph; waw takes qamets: וָ)
- **I-aleph verbs (יֹאמַר class):** holem-prefix imperfect → וַיֹּאמֶר (most frequent wayyiqtol in the Bible)

### Weqatal formation

- **וְ + perfect form** with stress shift to ultima (final syllable)
- In 2ms: וְשָׁמַרְתָּ (stress on -tā, not on -mar-)
- Otherwise, the form is morphologically identical to the perfect — context (following an imperfect or command) identifies it
...
→ Full paradigm tables: [wayyiqtol-weqatal-paradigms.md](wayyiqtol-weqatal-paradigms.md)
...
1. **Is there a וַ- prefix?** (waw + pathach/qamets + dagesh forte in prefix consonant)
   - Yes → likely Wayyiqtol
   - No → Imperfect, Perfect, or other form
2. **Is the prefix consonant doubled (dagesh forte)?**
   - In יּ, נּ, תּ: visible dagesh → Wayyiqtol
   - Exception: **aleph and resh** cannot take dagesh — look for compensatory lengthening or context
3. **Is it a weak verb in a short form?**
   - III-ה: ends without ה (e.g. וַיִּבֶן, not וַיִּבְנֶה) → Wayyiqtol short form
   - Biconsonantal: qamets hatuf in the root vowel (וַיָּ֫קׇם vs. יָקוּם) → Wayyiqtol
4. **Context:** Is this sequential narrative with past-time reference? → Wayyiqtol
