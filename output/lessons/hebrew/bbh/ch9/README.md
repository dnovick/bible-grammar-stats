...
- **Type 1** — attached to singular nouns. The noun takes a construct-like form (often with vowel reduction in the stem) before the suffix connects.
- **Type 2** — attached to plural nouns and to prepositions that have a built-in plural-like connecting vowel. The Type 2 suffix contains a yod (י) connecting element in most cells.
