...
> - מְ + **ֻ under R1** + **dagesh in R2** → **Pual** (passive of Piel)
> - מוּ or מֻ with **no dagesh in R2** → **Hophal** (passive of Hiphil)
>
> Look at the Perfect:
> - No prefix consonant + **ֻ under R1** + **dagesh in R2** → **Pual**
