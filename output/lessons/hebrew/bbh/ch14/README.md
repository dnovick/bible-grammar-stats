...
|---|---|
| [exercises/ch14-passage-exercise/](exercises/ch14-passage-exercise/README.md) | Parse weak-root Qal Perfect verbs from a Torah passage; includes Weak Class column |
| [exercises/ch14-weak-form-id/](exercises/ch14-weak-form-id/README.md) | 40 forms across all eight classes — identify class, PGN, and root |
...
→ Full paradigm: [qal-perfect-weak-lamed-aleph-paradigms.md](qal-perfect-weak-lamed-aleph-paradigms.md)
...
→ Full paradigm: [qal-perfect-weak-lamed-he-paradigms.md](qal-perfect-weak-lamed-he-paradigms.md)
...
→ Full paradigm: [qal-perfect-weak-lamed-guttural-paradigms.md](qal-perfect-weak-lamed-guttural-paradigms.md)
...
- **All perfect forms:** essentially regular; the guttural simply takes chateph-patach
  where a short vocal shewa would be expected in reduced syllables
- **The main I-guttural weak effects appear in the Imperfect** (Ch16) and Hiphil (Ch26)

### Diagnostic Markers

- **3ms:** qamets under guttural + patach under R2 — e.g., עָמַד, אָמַר (virtually identical
  to strong קָטַל with גuttural at R1)
- **Reduced forms (3cp, 2mp):** chateph-patach replaces vocal shewa under guttural:
  עָמְדוּ → chateph under ע in some forms
...
→ Full paradigm: [qal-perfect-weak-pe-guttural-paradigms.md](qal-perfect-weak-pe-guttural-paradigms.md)
...
→ Full paradigm: [qal-perfect-weak-pe-paradigms.md](qal-perfect-weak-pe-paradigms.md) (Part 1)
...
→ Full paradigm: [qal-perfect-weak-pe-paradigms.md](qal-perfect-weak-pe-paradigms.md) (Part 2)
...
→ Full paradigm: [qal-perfect-weak-biconsonantal-paradigms.md](qal-perfect-weak-biconsonantal-paradigms.md)
...
- **3ms:** the doubled radical is written with **dagesh forte** in R2 when the root is
  "uncontracted": סָבַב, תָּמַם — or in contracted form with lengthening: סָ֫ב, תָּ֫ם
- **Contracted 3ms:** some Geminate roots use a short contracted form (R1 + long vowel):
  e.g., תָּ֫ם (from תָּמַם) — visually similar to Biconsonantal
- **Suffixed forms:** the doubled consonant appears: סַ֫בֹּתָ, תַּ֫מַּמְתִּי
- **Critical confusable:** Geminate and Biconsonantal 3ms forms can be nearly identical;
  only root knowledge (R2 = R3 for Geminate vs. middle vowel letter for Biconsonantal)
...
→ Full paradigm: [qal-perfect-weak-geminate-paradigms.md](qal-perfect-weak-geminate-paradigms.md)
