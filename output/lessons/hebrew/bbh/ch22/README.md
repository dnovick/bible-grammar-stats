...
Full paradigm tables are in the [paradigm reference file](participle-paradigms.md).

| Form | BBH § | Notes |
|---|---|---|
| [Active Ptc. — Strong roots](participle-paradigms.md#active-participle-strong-roots) | §22.3 | Holem-waw + tsere pattern |
| [Active Ptc. — Weak roots](participle-paradigms.md#active-participle-weak-roots) | §22.4 | III-ה, Biconsonantal, I-י |
| [Passive Ptc. — All roots](participle-paradigms.md#passive-participle) | §22.5 | Qatûl pattern (qamets + shureq) |
| [Full inflection table](participle-paradigms.md#full-inflection-table) | §22.3 | ms / fs / mp / fp with construct forms |
