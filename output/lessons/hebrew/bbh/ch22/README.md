...
| File | Description |
|---|---|
| [ch22-qal-participle.md](ch22-qal-participle.md) | Full lesson: active and passive participle functions, form diagnostics (holem-waw/tsere vs. qatûl), paradigm links, Torah lemma frequencies for both active and passive, example passages, conjugation distribution, parsing quick reference |
